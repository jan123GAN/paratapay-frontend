...
function Expense() {
  ...
  const handleOpenSettlementModal = async (expense: any) => {
    try {
      const detail = await getExpenseById(expense.id);
      setSettleExpenseData(detail);
    } catch (error) {
      console.error("Failed to fetch expense detail for settlement", error);
                ...
                <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-3 shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <Button 
                      ...
                      onClick={() => void handleOpenSettlementModal(expense)}
                    >
                  ...
                  return (
                    <Button 
                      ...
                      onClick={() => {
                        ...
                        setSelectedExpenseId(null);
                        void handleOpenSettlementModal(exp);
                      }}
                    >
